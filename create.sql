...
insert into column_a (id_column, id_board, name, has_estimative) values (1, 1, 'Coluna A', true);
insert into column_a (id_column, id_board, name, has_estimative) values (2, 1, 'Coluna B', true);
insert into column_a (id_column, id_board, name, has_estimative) values (3, 1, 'Coluna C', true);
